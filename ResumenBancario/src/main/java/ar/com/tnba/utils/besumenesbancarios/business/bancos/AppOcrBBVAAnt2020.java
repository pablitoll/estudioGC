...
public class AppOcrBBVAAnt2020 extends BaseBancos {

	public AppOcrBBVAAnt2020() {
		super(Bancos.FRANCESAnt);
	}
...
//		Integer idxFin = CommonUtils.minimo(vecMin);
		...
		vecMin[0] = strOcr.lastIndexOf(TRANSPORTE_SALDO);
		vecMin[1] = strOcr.indexOf(SALDO_AL);

		Integer idxFin = CommonUtils.maximo(vecMin);
