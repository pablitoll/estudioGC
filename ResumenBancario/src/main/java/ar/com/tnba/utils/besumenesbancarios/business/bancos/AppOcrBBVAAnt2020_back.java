...
public class AppOcrBBVAAnt2020_back extends BaseBancos {
	...
	private static final String TRANSPORTE = "TRANSPORTE SALDO";
...
//	}
	...
	protected String[] getRegistrosFromOCR(String strOcr, File archivo, Integer nroPapagina) throws Exception {
		...
		if (idxFin == -1) {
			idxFin = strOcr.indexOf(TRANSPORTE);
		}
